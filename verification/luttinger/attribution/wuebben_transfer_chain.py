#!/usr/bin/env python3
"""ATTRIBUTION TRACK ONLY.  This is the former downstream_chain.py (Runs 64,
66), moved here unchanged in content by Run 74.  It transfers Wuebben's
Theorems A, B and C (arXiv:2608.17267) to the audit manifold under the
source-comparison assumption D1--D14 and through Lidman--Piccirillo's sigma,
quotient, regluing and Floer lemmas.  Nothing on the existence path of
Theorem A' (../downstream_chain.py) depends on it; it is kept, replayable,
as the record of what the comparison with those papers would establish IF
D1--D14 held.
...
wuebben_transfer_chain_certificate.json; run with --check to recompute and compare
...
ROOT = HERE.parent.parent          # verification/
OUTPUT = HERE / "wuebben_transfer_chain_certificate.json"
