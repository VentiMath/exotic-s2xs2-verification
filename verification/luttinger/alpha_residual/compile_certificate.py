#!/usr/bin/env python3
"""Compile a KBMAG history into a proof of the alpha residual identity.
...
def main():
    ...
    if source["format"] != "luttinger-alpha-residual-source-v1":
        raise SystemExit("wrong alpha-residual source format")
    ...
    if normal:
        raise RuntimeError(
            f"alpha residual has nonempty normal form {normal}"
        )
    ...
    certificate = {
        "format": "luttinger-alpha-residual-proof-v1",
