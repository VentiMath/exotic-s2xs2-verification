...
\begin{center}\small
\texttt{bc6806eb9b4065377d6194ff3797fbb02d58b386}.
\end{center}
...
\begin{center}\small
\texttt{49c1a7ad02a38cf26c7796a2cc4d471df3ed78c74da7c4c73348c20c0163fa29}.
\end{center}
...
bundles; symplectic Kodaira dimension after Li and Liu; and Ho--Li), 4
certificates ($\pione(V_{\mathrm{aud}})=1$; $\Ghat\cdot\Ghat=0$; the
framing identification; the seam identity of $\sigma_{\mathrm{aud}}$), 3
bound proofs (the split form, the double, and the descent of the form), 5
computed facts, and 7 steps, ending in Theorem~A$'$.  The separately
...
The v2.3.0 manuscript and supplement correspond to that tagged release and
its archival deposit.  The working revision instead uses the manifest and
verification-tree object printed at the start of this section; it is not an
immutable release packet yet.
