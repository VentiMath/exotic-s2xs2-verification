...
This release adds the small checker
...
to the Audit-Manifold Theorem.  The v2.3.0 manifest binds it.  Its output
distinguishes finite arithmetic from the topological hypotheses established
in prose.  This release also repairs Python's integer-letter check so
...
\texttt{v2.3.0} of the repository:
\begin{center}\small\url{https://github.com/VentiMath/exotic-s2xs2-verification/releases/tag/v2.3.0}\end{center}
The v2.3.0 verification snapshot is permanently archived at
\begin{center}\small\url{https://doi.org/10.5281/zenodo.22184725}\end{center}
with concept DOI
...
archival deposit, and use the manifest and verification-tree object printed
at the start of this section.
The \texttt{verification/} tree of that release has git tree object hash
\begin{center}\small\texttt{d784d5502d414a206bd60e10c0ee995c26688e2c}\end{center}
recoverable from a clean checkout as
\texttt{git rev-parse v2.3.0:verification};
...
\begin{center}\small\texttt{73257b9ea0883255bb15c70f77f551526eec1714a866ab9e645cfe374528e8ca}\end{center}
