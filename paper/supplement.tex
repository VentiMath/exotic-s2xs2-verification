...
\hypersetup{
  pdftitle={Supplement to Certificate-checked simple connectivity of a surface-bundle surgery manifold},
...
Certificate-checked simple connectivity of a\\
...
\begin{abstract}
This supplement preserves the implementation inventory, source-comparison
checklist, historical conditional applications, trust boundary, data pins,
calibrations, and superseded exports behind the main paper.  The article
proves source-independent topological and symplectic statements about
$V_{\mathrm{aud}}$.  The comparison $V_{\mathrm{aud}}\cong V$ is not a
theorem there: clauses D1--D14 below record what a future comparison must
establish.  The former exotic-manifold application is retained only as a
conditional dependency audit relative to that checklist and named external
results.
\end{abstract}
...
$V_{\mathrm{aud}}$, and a separate product-to-Lagrangian framing theorem.
...
Appendix~\ref{sec:downstream} preserves the historical
proposition-by-proposition conditional chain; Appendix~\ref{sec:trust}
...
member.  The full clause-by-clause comparison checklist follows; the
...
SHA-256
\begin{center}\small
\texttt{668e6dac41ac04340c25ca1eb06272512e8ad92353d94c866730dfefd5878d63}.
\end{center}
...
\end{center}
The archived \texttt{verification/} directory has git tree object
\begin{center}\small
\texttt{edb24057eb60a831b618bd103ab05c3ad13c92ae}.
\end{center}
These three identifiers are the operational root referenced by the finite
...
This post-v2.2.2 working revision adds the small checker
...
to the Audit-Manifold Theorem.  It is not part of the archived v2.2.2
manifest and must be bound by the next release before submission.  Its output
...
of $V$.  This appendix is historical and conditional: assume every clause
D1--D14 above and thereby identify the audit-defined
$V_{\mathrm{aud}}$ with this $V$.
