% Computational supplement to the certificate-based audit.
...
the marked geometric identification remains the principal expert-review
boundary, and the downstream manifold conclusions are relative to named
external results.
\end{abstract}

\section*{How to use this supplement}
The main paper contains the mathematical certificate specification and the
proof of the Geometric Identification Theorem.  Section~\ref{sec:certificates}
...
(the Geometric Identification Theorem of the main paper), and Luttinger surgery preserves the form
...
\subsection*{Inputs to the finite theorem of the main paper and
the Geometric Identification Theorem of the main paper}

the finite theorem of the main paper has no mathematical input beyond
the Certificate Soundness Theorem of the main paper; its trust rests on the two small checkers.
the Geometric Identification Theorem of the main paper rests on standard inputs of PL topology: the
...
together with the dashed-arc convention explained in the model section of
the main paper. This note reproves none of these.
...
clean-checkout replay instructions, in the tagged release \texttt{v1.5.9}
of the repository:
\begin{center}\small\url{https://github.com/VentiMath/exotic-s2xs2-verification/releases/tag/v1.5.9}\end{center}
The \texttt{verification/} tree of that release is identical to that of
the repository commit
\begin{center}\small\texttt{8efbe7c2f43e01041263378dd836008e9747dcda}\end{center}
...
\begin{center}\small\texttt{fbd31c4abd548093e6d3b73054d54cc0c3588e804a3374911e820abe6b66842e}\end{center}
