...
clean-checkout replay instructions, in the tagged release \texttt{v2.2.1}
of the repository:
\begin{center}\small\url{https://github.com/VentiMath/exotic-s2xs2-verification/releases/tag/v2.2.1}\end{center}
The v2.2.1 verification snapshot is permanently archived at
\begin{center}\small\url{https://doi.org/10.5281/zenodo.22181589}\end{center}
with concept DOI
...
The v2.2.1 manuscript and supplement correspond to the tagged release and
...
\texttt{git rev-parse v2.2.1:verification};
