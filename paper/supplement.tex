...
clean-checkout replay instructions, in the tagged release \texttt{v2.2.2}
of the repository:
\begin{center}\small\url{https://github.com/VentiMath/exotic-s2xs2-verification/releases/tag/v2.2.2}\end{center}
The v2.2.2 verification snapshot is permanently archived at
\begin{center}\small\url{https://doi.org/10.5281/zenodo.22182187}\end{center}
with concept DOI
...
The v2.2.2 manuscript and supplement correspond to that tagged release and
its archival deposit.
...
\texttt{git rev-parse v2.2.2:verification};
