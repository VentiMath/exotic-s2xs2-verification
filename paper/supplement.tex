...
in prose.  The working revision also repairs Python's integer-letter check so
that JSON booleans are rejected and expands its built-in corruption tests to
match the Ruby checker's major failure classes.  That revised checker must
likewise be rebound by the next manifest.  The external checker and geometry
