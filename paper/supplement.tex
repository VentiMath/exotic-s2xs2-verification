...
Certified simple connectivity of an audit model for\\
Wuebben's proposed exotic $S^2\times S^2$ construction}
...
the source-comparison clauses of Source Formalization~D.
...
of $V$.  Throughout this appendix, Source Formalization~D of the main paper
is a standing hypothesis, so its audit-defined $V_{\mathrm{aud}}$ has been
...
(the audit-model theorem together with Source Formalization~D of the main
paper), and
...
Theorem~C, and the Conditional Downstream Corollary of the main paper follows.
...
Source Formalization~D in the main paper is a separate evidence kind, not an
...
depend on Source Formalization~D; the finite theorem and
$\pione(V_{\mathrm{aud}})=1$ do not.

\subsection*{Inputs to the Conditional Downstream Corollary of the main paper}
...
\begin{center}\small\texttt{b355f2fd015db96ebff8ca842a83e67a52060f69}\end{center}
