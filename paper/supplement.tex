...
clean-checkout replay instructions, in the tagged release \texttt{v2.0.0}
of the repository:
\begin{center}\small\url{https://github.com/VentiMath/exotic-s2xs2-verification/releases/tag/v2.0.0}\end{center}
