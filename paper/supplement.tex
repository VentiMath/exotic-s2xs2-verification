...
\hypersetup{
  pdftitle={Mathematical and computational supplement to A certificate-based audit of simple connectivity for an explicit model associated with Wuebben's proposed exotic S2 x S2 construction},
  pdfauthor={John Clyde},
  pdfsubject={Supplementary certificate inventory, source-comparison ledger, and conditional topology deductions},
...
\cite[Chapters~2--4, especially Corollary~4.2]{RourkeSanderson} and
...
opening statement of \cite[\S2.1]{ADK}.  No smoothing theorem is claimed to
...
bridge, an independent review should answer the following six concrete
...
The archived v2.2.1 manuscript and supplement correspond to that tagged
release and archival deposit.  This visibly labeled working revision is not
represented as a new immutable release.
